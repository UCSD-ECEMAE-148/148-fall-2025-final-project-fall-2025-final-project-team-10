...
def generate_launch_description():
    ...
    explore_config = '/home/projects/ros2_ws/src/explore.yaml'
    mux_config  = '/home/projects/ros2_ws/src/twist_mux_params.yaml'
    ...
    return LaunchDescription([
        Node(
            ...
            remappings=[
                ('cmd_vel_out', '/cmd_vel') # Mux output goes to VESC
            ]
        ),
        Node(
            package='locate_pkg',
            ...
            name='locate_node',
            remappings=[
                ('/cmd_vel', '/locate/cmd_vel')
            ] # FIXED: Now pipes to Mux
        ),
#        Node(
...
#            name='explore_node',
#            output='screen',
#            parameters=[explore_config, {'robot_base_frame': 'base_link'}],
#            remappings=[
#                ('/cmd_vel', '/explore/cmd_vel') # <--- CRITICAL FIX
#            ]
#        ),
        # 1. HARDWARE: Lidar
        ...
        TimerAction(
            ...
            actions=[
                ...
                GroupAction(
                    actions=[
                        # Remap Nav2's output from /cmd_vel to /explore/cmd_vel
                        SetRemap(src='cmd_vel', dst='/explore/cmd_vel'),
                        SetRemap(src='/cmd_vel', dst='/explore/cmd_vel'),
                        IncludeLaunchDescription(
