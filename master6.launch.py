...
def generate_launch_description():
    ...
    mux_config = '/home/projects/ros2_ws/src/twist_mux_params.yaml'  # twist_mux params
    explore_params = '/home/projects/ros2_ws/src/explore.yaml'
    ...
    return LaunchDescription([
        ...
        # --- MUX stop publisher ---
        ExecuteProcess(
            cmd=['ros2', 'run', 'mux_pkg', 'stop_publisher'],
            output='screen'
        ),

        # --- EXPLORE_LITE ---
        ExecuteProcess(
            cmd=['ros2', 'run', 'explore_lite', 'explore', '--ros-args', '--params-file', explore_params],
            output='screen'
        ),

        # --- New Nodes Added ---

        # camera_pkg 5fps node (commented out)
#        Node(
#            package='camera_pkg',
#            executable='5fps',
